...
Link to video (Portfolio Piece Video): https://drive.google.com/drive/u/0/folders/1dbX5tlqHqz_1A_qh9NPGcZ5EyeW3toUn
...
1. **Clone the repository:**
   ```bash
   git clone 
repository url - (https://github.com/HloleloRampete/JSF-Portfolio_Piece_HLORAM373_JSE2407_GroupB_Hlolelo-Rampete_JSF04.git)
   ```
